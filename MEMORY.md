...
- **Ingest checksum validation**: Source-file I/O and SHA-256 hashing must run off `AppModel`'s main actor; await only the result for skip-state publication and propagate task cancellation.
