...
- 2026-07-16 PR hardening: GitHub dependency review was unsupported because the owner-controlled dependency graph is disabled. The PR workflow now preflights that API capability, warns/skips only when unavailable, and retains mandatory Cargo/Python lockfile audits; actionlint, zizmor, and release-policy regressions pass.
