...
- Release evidence: migration PR #4 merged as `88f7d5e7c373226eb3861277ba9ca6a57f5e8774`; exact-main workflow run `29782445124` passed; `v1.0.0` targets that SHA. Apple submission `68cc41be-2f44-4650-a731-ec1e5a042f3f` is `Accepted`; published DMG SHA-256 is `f2fc0c5ec19831213e1dcd0ea4d6fe104a890fdaae821a581e5ce5d4af108c20`; app SPDX SHA-256 is `cd5d9b6cb620b3ec7191e3bdb9e6aba7004d35227f5230d0eb49bb9598c76440`; public bytes match. Release-evidence PR #5 passed all ten hosted checks and rebased reviewed head `d9835891b7276122c45c06d27147966f810d2da9` onto protected `main` as `9d14a50c7eebae61ab2511d21437ee203870f96a`.
- Tradeoffs/blockers: the macOS direct-download lane and repository migration are complete. The local Xcode build-service issue was bypassed with exact-main hosted proof without terminating unrelated tasks. iPad App Store publication remains a separate external lane. Existing user `Output/` audit findings are preserved unchanged. The formal Codex Security scan remained excluded by user direction. GitHub preserved the requested no-reply author/sign-off on PR #5's rebased commit but recorded its account-side legacy identity as committer; rewriting published evidence or release provenance for that platform metadata was rejected.
