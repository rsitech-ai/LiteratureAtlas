...
The debate should help a research team decide which approach is more promising to prototype.
...
- Then produce {{rounds}} rounds. Each round has:
  - A: 2-3 sentences (include application implications, data needs, risks if inferable)
  - B: 2-3 sentences (same)
- End with bullet lists for:
  - Agreements
  - Disagreements
  - Next experiments (must be evaluation/prototype oriented, 4-7 bullets)
