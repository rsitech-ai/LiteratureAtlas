...
PR #11 executed dependency review and passed all substantive hosted checks.
...
unavailable/disabled for this repository. Immutable releases, restricted Action
allowlisting, and optional public Scorecard publication remain separate owner
decisions. The PR workflow detects an
